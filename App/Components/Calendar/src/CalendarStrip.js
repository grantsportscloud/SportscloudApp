...
import { View, Animated, PixelRatio,Text } from "react-native";
        ...
        <View style={[this.props.innerStyle, { height: this.state.height }]}>
          ...
          <View style={styles.datesStrip}>
            ...
            />
             ...
             <View style={{borderWidth:0.8,width:'40%',marginRight:8,borderRadius:15,borderColor:'white'}}>
                        <CommonPicker
